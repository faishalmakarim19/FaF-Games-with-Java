 ...
 * @author VICTUS
 */
public class Tebak1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/finalproject/AS ASLI.png"))); // NOI18N
        jLabel1.setPreferredSize(new java.awt.Dimension(360, 500));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 90, 130));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/finalproject/OTAK ASLI.jpg"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 140, 110));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/finalproject/ah.jpg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 70, 80, 50));
    ...
    private void btSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSubmitActionPerformed
        ...
        if(coba<=3 && jtfJawaban.getText().toLowerCase().equals("asah otak")){
            JOptionPane.showMessageDialog(null,"Jawaban Anda Benar");
            this.dispose();
            new Tebak11().setVisible(true); //untuk lanjut ke soal tebak2
            ...
            Pattern pattern = Pattern.compile("\\b(asah|otak)\\b", Pattern.CASE_INSENSITIVE);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(hint==1){
            ...
            JOptionPane.showMessageDialog(null,"Asah ........");
            hint++;
            }
